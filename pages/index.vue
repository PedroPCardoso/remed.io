    ...
    pesquisar: function () {
      ...
      'Homatropina': "Podem agravar a constipação devido à forte ação anticolinérgica Exceção1: Evitar, a menos que não haja outra alternativa.",
       'Escopolamina': "Podem agravar a constipação devido à forte ação anticolinérgica Exceção1: Evitar, a menos que não haja outra alternativa.",
        ...
        'nimesulida': "'<div> <br> <br> <b > Motivo pelo qual é um MPI </br> A nimesulida está associada a um risco ligeiramente aumentado de hepatotoxicidade, que aumenta com o tempo de exposição e a dosagem. Recomenda-se a restrição do seu uso ao tratamento da dor aguda, tratamento sintomático da osteoartrite dolorosa e dismenorreia primária. </div>' '<div> <br><br>  <b > Ajuste de dose/ considerações especiais de uso </b> A nimesulida está associada a um risco ligeiramente aumentado de hepatotoxicidade, que aumenta com o tempo de exposição e a dosagem. Recomenda-se a restrição do seu uso ao tratamento da dor aguda, tratamento sintomático da osteoartrite dolorosa e dismenorreia primária.   </div>' '<div> <br><br>  <b >Medicamentos e/ou terapias alternativas </b> <br> Paracetamol; ibuprofeno (≤ 3 x 400 mg/d ou durante menos de uma semana); naproxeno (≤ 2 x 250 mg/d ou durante menos de uma semana). Opióides com menor risco de delírio (por exemplo, naloxona, morfina, oxicodona, buprenorfina, hidromorfona). </div>'",
        
        'Etodolac': " '<div> <br> <br> <b > Motivo pelo qual é um MPI </br> Elevado risco de sangramento, ulceração ou perfuração gastrointestinal, que pode ser fatal </div>' '<div> <br><br>  <b > Ajuste de dose/ considerações especiais de uso </b> <br> Os idosos têm uma frequência mais elevada de reações adversas com AINEs, principalmente hemorragias e perfurações gastrointestinais, que podem ser fatais. </div>' '<div> <br><br>  <b >Medicamentos e/ou terapias alternativas </b> <br> Paracetamol; ibuprofeno (≤ 3 x 400 mg/d ou durante menos de uma semana); naproxeno (≤ 2 x 250 mg/d ou durante menos de uma semana). Opióides com menor risco de delírio (por exemplo, naloxona, morfina, oxicodona, buprenorfina, hidromorfona). </div>'",
       'Dexclorfeniramina': " '<div> <br> <br> <b > Motivo pelo qual é um MPI </br> Dentre os anti-histamínicos prescritos e não prescritos, muitos podem ter propriedades anticolinérgicas </div>' '<div> <br><br>  <b > Ajuste de dose/ considerações especiais de uso </b> <br> </div>' '<div> <br><br>  <b >Medicamentos e/ou terapias alternativas </b> <br> </div>'",

      'Nitrofurantoína': " '<div> <br> <br> <b > Motivo pelo qual é um MPI </br> Potencial para insuficiência rena </div>' '<div> <br><br>  <b > Ajuste de dose/ considerações especiais de uso </b> <br> </div>' '<div> <br><br>  <b >Medicamentos e/ou terapias alternativas </b> <br> Cefalexina. Ciprofloxacino. SMT + TMP </div>'",

      'Digoxina': " '<div> <br> <br> <b > Motivo pelo qual é um MPI </br> Diminuição da depuração renal pode levar a aumento do risco de efeitos tóxicos. </div>' '<div> <br><br>  <b > Ajuste de dose/ considerações especiais de uso </b> <br> </div>' '<div> <br><br>  <b >Medicamentos e/ou terapias alternativas </b> <br> Digoxina em doses inferiores às recomendadas. Carvedilol. </div>'",
