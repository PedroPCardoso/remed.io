    ...
    pesquisar: function () {
      ...
      'Homatropina': "Podem agravar a constipação devido à forte ação anticolinérgica Exceção1: Evitar, a menos que não haja outra alternativa.",
       'Escopolamina': "Podem agravar a constipação devido à forte ação anticolinérgica Exceção1: Evitar, a menos que não haja outra alternativa.",
        ...
        'Nimesulida': "'<div> <br> <br> <b > Motivo pelo qual é um MPI</b> </br> A nimesulida está associada a um risco ligeiramente aumentado de hepatotoxicidade, que aumenta com o tempo de exposição e a dosagem. Recomenda-se a restrição do seu uso ao tratamento da dor aguda, tratamento sintomático da osteoartrite dolorosa e dismenorreia primária. </div>' '<div> <br><br>  <b > Ajuste de dose/ considerações especiais de uso </b> <br> <br>  A nimesulida está associada a um risco ligeiramente aumentado de hepatotoxicidade, que aumenta com o tempo de exposição e a dosagem. Recomenda-se a restrição do seu uso ao tratamento da dor aguda, tratamento sintomático da osteoartrite dolorosa e dismenorreia primária.   </div>' '<div> <br><br>  <b >Medicamentos e/ou terapias alternativas </b> <br><br>  Paracetamol; ibuprofeno (≤ 3 x 400 mg/d ou durante menos de uma semana); naproxeno (≤ 2 x 250 mg/d ou durante menos de uma semana). Opióides com menor risco de delírio (por exemplo, naloxona, morfina, oxicodona, buprenorfina, hidromorfona). </div>'",
