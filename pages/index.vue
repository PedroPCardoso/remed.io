...
'Nimesulida': "'<div> <br> <br> <b > Motivo pelo qual é um MPI</b> </br> Risco pronunciado de sangramento gastrointestinal ou úlcera péptica em grupos de alto risco (ex.: idade superior a 75 anos, tomando corticoesteroides, anticoagulantes e/ou agentes antiplaquerios). Uso concomitante de inibidor de bomba de prótons reduz, mas não elimina o risco. </div>' '<div> <br><br> <b > Ajuste de dose/ considerações especiais de uso </b> <br> <br> A nimesulida está associada a um risco ligeiramente aumentado de hepatotoxicidade, que aumenta com o tempo de exposição e as  taxa. Recomenda-se a restrição do seu uso ao tratamento da dor aguda, tratamento sintomático da osteoartrite dolorosa e dismenorreia primária. </div>' '<div> <br><br> <b >Medicamentos e/ou terapias alternativas </b> <br><br> Paracetamol para dor leve a moderada. </div>'",
      ...
      'Metildopa': "'<div> <br> <br> <b > Motivo pelo qual é um MPI</b> </br> Possui Alto risco de efeitos adversos no sistema nervoso central. Pode causar bradicardia e hipotensão ortostática. </div>' '<div> <br><br> <b > Ajuste de dose/ considerações especiais de uso </b> <br> <br> Não recomendado como tratamento de primeira escolha para hipertensão. </div>' '<div> <br><br> <b >Medicamentos e/ou terapias alternativas </b> <br><br>Outros anti-hipertensivos (ex.: diuréticos tiazídicos, inibidores da Enzima Conversora da Angiotensina, bloqueador de receptor de angiotensina, bloqueadores de canal de cálcio). Ex: Hidroclorotiazida. </div>'",
      'Dexclorfeniramina': "'<div> <br> <br> <b > Motivo pelo qual é um MPI</b> </br> Possui eliminação reduzida entre idosos. Risco de confusão, boca seca, constipação e outros efeitos anticolinérgicos. </div>' '<div> <br><br> <b > Ajuste de dose/ considerações especiais de uso </b> <br> <br> Utilizar por um menor período/optar por medicamentos de segunda ou terceira geração </div>' '<div> <br><br> <b >Medicamentos e/ou terapias alternativas </b> <br><br> Soro fisiológico nasal. Anti-histamínico de segunda geração (ex.: loratadina). Corticoesteroide intranasal (ex.: budesonida). </div>'",
      ...
      'Amitriptilina': "'<div> <br> <br> <b > Motivo pelo qual é um MPI</b> </br>Efeito anticolinérgico pronunciado. Causa sedação e hipotensão ortostática. Risco de eventos adversos maior entre idosos com demência, glaucoma de ângulo estreito, disfunções na condução cardíaca e histórico de retenção urinária. </div>' '<div> <br><br> <b > Ajuste de dose/ considerações especiais de uso </b> <br> <br> Optar por terapias farmacológicas mais seguras </div>' '<div> <br><br> <b >Medicamentos e/ou terapias alternativas </b> <br><br> Para dor neuropática: inibidores da recaptação de serotonina e noradrenalina, gabapentina, pregabalina. Para depressão: inibidores da recaptação de serotonina seletivos (exceto paroxetina e fluoxetina), inibidores da recaptação de serotonina e noradrenalina, bupropiona. </div>'",
